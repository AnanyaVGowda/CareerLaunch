...
const FinalResumeViewContent = ({ params }: { params: { id: string } }) => {
        ...
        <div className="flex max-sm:flex-col justify-center gap-8 my-10">
          ...
          <RWebShare
            data={{
              ...
              url: `${process.env.NEXT_PUBLIC_BASE_URL || window.location.origin}${path}`,
  ...
  return (
    <PageWrapper>
      <FormProvider params={params}>
        <FinalResumeViewContent params={params} />
